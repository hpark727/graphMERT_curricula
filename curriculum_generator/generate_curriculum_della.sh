...
#SBATCH --output=/scratch/gpfs/%u/logs/curriculum_gen_%j.out
#SBATCH --error=/scratch/gpfs/%u/logs/curriculum_gen_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
REPO_DIR="/scratch/gpfs/$USER/bottom-up-superintelligence"
OUTPUT_DIR="/scratch/gpfs/$USER/curriculum_training_data"
HF_CACHE="/scratch/gpfs/$USER/.cache/huggingface"
# -------------------------------------------------------------------------

mkdir -p "$OUTPUT_DIR" /scratch/gpfs/$USER/logs
